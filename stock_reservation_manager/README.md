...
Operational visibility and permission-controlled management of Odoo 17's native stock reservations. The module never stores a parallel stock balance and never writes `stock.quant` quantities directly.

## Odoo 17 reservation model
